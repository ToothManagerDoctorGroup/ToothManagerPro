...
NSString *const XLContactAccessAllowedNotification = @"XLContactAccessAllowedNotification";
NSString *const XLContactAccessDeniedNotification = @"XLContactAccessDeniedNotification";
    ...
    if (status == kABAuthorizationStatusAuthorized){
        ...
        ABAddressBookRequestAccessWithCompletion(addressBookRef, ^(bool granted, CFErrorRef error){
            ...
            if (granted) {
                ...
                [self copyAddressBook:addressBook];
                CFRelease(addressBook);
                [XLContactsManager postMainThreadNotification:XLContactAccessAllowedNotification];
            } else {
                [XLContactsManager postMainThreadNotification:XLContactAccessDeniedNotification];
            }
        });
    }
    else {
...
#pragma clang diagnostic ignored "-Wunused-variable"
    ...
    for ( int i = 0; i < numberOfPeople; i++){
        ...
        XLContact *contact = [XLContact new];
