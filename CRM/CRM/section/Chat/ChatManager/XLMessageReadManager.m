...
static XLMessageReadManager *detailInstance = nil;

@interface XLMessageReadManager ()
...
@implementation XLMessageReadManager
            ...
            updateViewCompletion:(void (^)(XLChatBaseModel *prevAudioModel, XLChatBaseModel *currentAudioModel))updateCompletion
{
    ...
    if(messageModel.messageType == XLMessageTypeVoice)
    {
        XLChatBaseModel *prevAudioModel = self.audioMessageModel;
        XLChatBaseModel *currentAudioModel = messageModel;
...
{
    XLChatBaseModel *model = nil;
    if (self.audioMessageModel.messageType == XLMessageTypeVoice) {
