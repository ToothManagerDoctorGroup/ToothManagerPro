...
//    if ([NSStringFromClass(vcClass) isEqualToString:NSStringFromClass([MyBillViewController class])]) {
//        viewController = [[MyBillViewController alloc] initWithStyle:UITableViewStyleGrouped];
//    }else{
