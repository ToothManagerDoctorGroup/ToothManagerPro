...
/**
 * Set the imageView `image` with an `url` and a placeholder.  show loading view in center when loading image
 *
 * The download is asynchronous and cached.
 *
 * @param url         The url for the image.
 ...
 * @see sd_setImageWithURL:placeholderImage:options:
 */
- (void)sd_setImageLoadingWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder;
...
@interface UIImageView (WebCacheDeprecated1)
