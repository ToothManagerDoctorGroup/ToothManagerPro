...
#import "TimFoundationProtocol.h"

@interface TimTableViewController : UITableViewController<UIGestureRecognizerDelegate>

//当cell中有输入框进入编辑状态，cell的delegate调用didBecomeFirstResponder
//firstResponderCell就记录了当前进入编辑状态了的cell
@property (nonatomic,retain) UITableViewCell *firstResponderCell;
...
@interface TimTableViewController (Notification)
...
@interface TimTableViewController (UIBarButtonItem)
